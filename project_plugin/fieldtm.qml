...
Item {
  ...
  Item {
    ...
    anchors {
      top: parent.top
      topMargin: mainWindow.sceneTopMargin + 12
  ...
  Rectangle {
    ...
    height: informationLayout.childrenRect.height + 24
    ...
    ColumnLayout {
      ...
      Text {
        ...
        text: {
          if (fieldTM.currentTask != undefined) {
            return qsTranslate("FieldTM", "Current Task Details");
          }
          return qsTranslate("FieldTM", "Pick a Task");
        }
      }
      ...
      Text {
        ...
        text: {
          if (fieldTM.currentTask != undefined) {
            return qsTranslate("FieldTM", "Task #%1 with %2 preexisting buildings.").arg(fieldTM.currentTask.attribute("task_id")).arg(fieldTM.currentTask.attribute("building_count"));
          }
